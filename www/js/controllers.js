...
MapApp.controller('SignInCtrl', ['$scope', '$cordovaOauth', '$ionicModal', 'loginService', 'helperService', 'fbURL', function ($scope, $cordovaOauth, $ionicModal, loginService, helperService, fbURL) {
    var fb = new Firebase(fbURL);
    ...
    $scope.logWithFacebook = function () {
        ...
        loginService.auth.$authWithOAuthPopup("facebook", {
            scope: "email"
        }).then(function (authData) {
    ...
    function ($scope, $firebaseAuth, $window, loginService, helperService) {
        ...
        $scope.createUser = function () {
            ...
            loginService.auth.$createUser(email, password).then(function () {
                ...
                loginService.mainFb.child("users").child(authData.uid).child("data").update({
                    name: name
                });
            }).catch(function (error) {
...
MapApp.controller('GpsCtrl', ['$scope', '$ionicModal', '$compile', 'leafletData', 'geoLocationService', 'displayPathService', 'leafletData', 'leafletEvents', 'loginService',
    'displayPathService',
    function ($scope, $ionicModal, $compile, leafletData, geoLocationService, displayPathService, leafletData, leafletEvents, loginService, displayPathService) {
